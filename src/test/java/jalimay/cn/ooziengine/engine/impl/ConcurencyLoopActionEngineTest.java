...
public class ConcurencyLoopActionEngineTest {
	...
	public void zeroAction() {
		AbstEngine engine = ConcurencyLoopActionEngine.newInstance(actionMap, 1, 10);
	...
	public void twoActionOneFailed() {
		...
		actionMap.put("A", actionA);
		actionMap.put("B", actionB);
		AbstEngine engine = ConcurencyLoopActionEngine.newInstance(actionMap, 2, 10);
